        ...
        <form onSubmit={submitUpload} className="flex flex-wrap items-end gap-3">
          ...
          <div>
            ...
            <input
              ...
              placeholder="1.3.0"
              className="w-28 bg-black border border-main rounded px-3 py-2 text-sm mono text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-emerald-500/50"
            />
          </div>
          <div>
            ...
            <input
              ...
              placeholder="7"
              className="w-24 bg-black border border-main rounded px-3 py-2 text-sm mono text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-emerald-500/50"
            />
          </div>
          <button
            type="submit"
      ...
      {loading ? (
        ...
        <>
          ...
          <div>
            ...
            {rollouts.length === 0 ? (
              <div className="bg-zinc-900 border border-main rounded-lg px-4 py-8 text-center text-zinc-500">
              ...
              <div className="space-y-3">
                {rollouts.map((r) => {
                  ...
                  return (
                    <div key={r.id} className="bg-zinc-900 border border-main rounded-lg p-4 space-y-3">
